...
func (tn *TagNaming) ID() string {
	return ID
}

func (tn *TagNaming) Name() string {
	return Name
}

func (tn *TagNaming) SetConfig(rawConfig interface{}) error {
	var config Config
	var err error
...
func (tn *TagNaming) GetConfig() rule.Config {
	return tn.config
}

func (tn *TagNaming) Run(ctx *rule.Context) error {
